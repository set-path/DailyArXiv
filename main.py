...
# keywords
keywords = ["Open Vocabulary Semantic Segmentation", "SAM3", "Remote Sensing Segmentation", "Remote Sensing Vision Language Model", "Vision Language Model"] # TODO add more keywords
